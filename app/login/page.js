      ...
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden relative">
        ...
        <div className="p-8 relative">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2">Please sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="text-xs font-medium text-violet-600 dark:text-violet-400 hover:text-violet-500 transition-colors">Forgot password?</a>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <Link href="/signup" className="font-medium text-violet-600 dark:text-violet-400 hover:text-violet-500 transition-colors">
              Sign up
            </Link>
          </div>
        </div>
